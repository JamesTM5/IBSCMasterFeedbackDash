...
for (i in degreeIndices:ncol(belongingnessDF)) {
  ...
  prepTotalBelongingness <- function (belongingnessDF) {
    ...
    belongingnessClassList[[2]] <- belongingnessDataPrepList[[2]][1:(length(belongingnessDataPrepList[[2]])-3)]
    belongingnessClassList[[3]] <- belongingnessSignificanceTesting(belongingnessDataPrepList$predictorsIn)
    belongingnessClassList[[4]] <- significantPredictors[[2]]
    belongingnessClassList[[3]] <- significantPredictors[[1]]
    ...
    belongingnessClassesList[[5]] <- valueTable
