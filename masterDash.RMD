...
#output$forcedirected1 <- renderForcedirected(forcedirected("Hello", testData$First))


repeatedforcedirectedOutput("repeatedforcedirected1")
output$repeatedforcedirected1 <- renderRepeatedforcedirected(repeatedforcedirected("Hello", testData))
```
...
# 
# source("assets/forcedirected/forcedirected.R")
# forcedirectedOutput("forcedirected2")
# output$forcedirected2 <- renderForcedirected(forcedirected("Hello", testData$First))
...
# 
# source("assets/forcedirected/forcedirected.R")
# forcedirectedOutput("forcedirected3")
# output$forcedirected3 <- renderForcedirected(forcedirected("Hello", testData$First))
